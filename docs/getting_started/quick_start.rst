...
While *torchtree* uses the `treezy <https://github.com/4ment/treezy>`_ library to parse and manipulate phylogenetic trees, it is recommended to use a Newick file due to the numerous variations of the NEXUS format.
